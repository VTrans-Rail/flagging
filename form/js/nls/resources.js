define({
  root: ({
    ...
    user: {
      ...
      shareUserTitleMessage: "Your request has been successfully submitted.",
      entrySubmitted: "Your request will be reviewed by VTrans and railroad staff shortly. You will receive an email with additional information.",
      ...
      shareModalFormText: "Your Status Tracking Link",
      close: "Close",
